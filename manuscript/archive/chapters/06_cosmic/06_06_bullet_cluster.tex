...
We successfully reconstructed this phenomenon using the \texttt{BulletClusterSim\_v2} engine, relying solely on the \textbf{Inductive Inertia} of the VSI substrate.
...
\textbf{Result:}
As shown in Figure \ref{fig:bullet_cluster}, the galaxies (carrying the majority of the inductive mass/gravity) separate from the gas naturally. \citestart This proves that "Dark Matter" is simply the observation of \textbf{High-Q Inductive Inertia} in condensed matter\cite{1,6}\citeend.
