...
\medskip\noindent
\textit{For the quantitative $\mu$-saturation treatment --- critical
field $B_c(T)$, Meissner reflection $\Gamma$, and the
$\varepsilon$--$\mu$ duality with plasma cutoff --- see
\S\ref{sec:superconductivity_duality} in
