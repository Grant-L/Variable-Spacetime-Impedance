...
\textbf{Physical Implication:} The randomness destroys the "Manhattan Distance" effect of regular grids. Light travels at the same average speed in every direction, satisfying Lorentz Invariance without requiring a continuum.