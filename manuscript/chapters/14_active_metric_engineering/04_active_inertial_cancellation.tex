...
\begin{figure}[htbp]
    ...
    \caption{\textbf{Active Inertial Cancellation (Transient Metric Snubber).} Simulation of a lethal 500-G deceleration maneuver. Because G-forces are identical to inductive vacuum voltage transients ($V_{spike} \propto -ma$), an active HTS hull coil can inject a precisely timed Counter-Electromotive Force (CEMF). This electrically shunts the topological wake, artificially dropping the internal passenger acceleration safely below the 9-G blackout limit.}
