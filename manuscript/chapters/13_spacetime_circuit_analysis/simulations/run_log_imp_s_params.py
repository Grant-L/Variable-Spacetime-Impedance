...
def simulate_log_scale_s_parameters():
    ...
    ax2.plot(r, S11_flawed, color='#E57373', lw=3, label='Standard Optical Dielectric Reflection ($S_{11} \gg -10$ dB)')
    ax2.plot(r, S11_eft, color='#4FC3F7', lw=4, label='AVE Condensate Match ($S_{11} \to -\infty$ dB)')
