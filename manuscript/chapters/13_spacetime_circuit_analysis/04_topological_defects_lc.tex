...
\begin{figure}[htbp]
    \centering
    \includegraphics[width=\textwidth]{simulations/outputs/orbital_reactive_power.png}
...
\begin{figure}[htbp]
    \centering
    \includegraphics[width=\textwidth]{simulations/outputs/condensate_imd_spectroscopy.png}
