...
\begin{figure}[h]
    ...
    \caption{\textbf{The 4th-Order Dielectric Saturation Limit.} Unlike standard Linear QED (Dashed Black), the AVE condensate (Red) imposes a hard geometric asymptote at $V_{crit}$. This non-linear curvature is the specific source of the 5th-order intermodulation products identified in the spectroscopy simulation.}
...
\begin{figure}[h]
    ...
    \caption{Condensate IMD Spectroscopy: The 4th-Order Harmonic Fingerprint. The non-linear saturation bound $(1-V^4)$ forces the generation of specific 5th-order sidebands, isolated from standard material noise.}
