...
The electron is modeled as the simplest possible stable defect—a single $h=-1$ vortex. Its "point-like" nature is an illusion of the $l_P$ scale; it is actually a localized region of metric strain where the manifold nodes are driven into the non-linear regime.
