...
\textbf{Conclusion:} Quarks are not independent fundamental particles possessing intrinsically fractional charges. They are \textit{deconfined quasiparticles} emerging from a frustrated topology. The global integer charge of the proton ($+1e$) is partitioned by the fundamental group $\pi_1$ of the Borromean knot complement. The $+2/3$ and $-1/3$ charges are the strict mathematical eigenvalues of the fractionalized $\theta$-vacuum acting on the local topological boundary conditions.