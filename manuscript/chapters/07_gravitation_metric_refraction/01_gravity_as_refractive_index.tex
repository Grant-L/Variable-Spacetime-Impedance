...
We model a mass $M$ as a \textbf{Point of Dilatation} (a localized volume expansion) in the substrate. The scalar lattice strain $\chi(r)$ is governed by the Poisson equation for an elastic solid:
\begin{equation}
