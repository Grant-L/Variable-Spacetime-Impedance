...
\begin{equation}
    \delta = \frac{4GM}{bc^2}
\end{equation}
\textbf{Result:} This perfectly recovers the Einstein deflection angle. In AVE, light curves not because space is bent, but because the \textbf{wavefront velocity is slower} near the mass ($v = c/n$), causing the ray to refract inward.
