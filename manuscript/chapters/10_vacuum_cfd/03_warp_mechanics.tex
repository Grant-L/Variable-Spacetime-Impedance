...
\begin{itemize}
    ...
    \item \textbf{Doppler Piling:} At the shock front, the lattice is stressed faster than it can relax ($\tau \approx l_0/c$). \citestart This forces the generated flux waves into the highest possible frequency modes (Gamma/Blue spectrum)\cite{einstein1916}\citeend.
\end{itemize}
