...
\begin{itemize}
    ...
    \item \textbf{Relativistic Speed ($v \to c$):} The vessel moves faster than the lattice relaxation time $\tau = l_{node}/c$. The nodes pile up in front of the hull, creating a high-density inductive wall ($\mu_{shock} \gg \mu_0$).
\end{itemize}
