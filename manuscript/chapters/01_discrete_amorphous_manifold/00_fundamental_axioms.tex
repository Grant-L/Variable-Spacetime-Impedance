...
\begin{itemize}
    ...
    \textit{Calibration Note:} Matching the derived Planck scale sets $l_0 \sim 10^{-35}\,\mathrm{m}$ (order-of-magnitude). In AVE $l_0$ is a primary input parameter of the mesh, not a secondary derivative of constants $G$ and $\hbar$.
