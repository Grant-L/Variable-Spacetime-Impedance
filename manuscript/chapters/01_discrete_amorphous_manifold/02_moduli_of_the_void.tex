...
\end{equation}
Mechanically, this is the inverse of the Bulk Modulus ($K$). It determines how "stiff" the vacuum is. A low $\permittivity$ implies a stiff lattice that transmits force at speeds approaching the lattice mode speed limit ($c$).
