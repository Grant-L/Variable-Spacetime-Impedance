...
We identify the Electron ($e^-$) as the simplest non-trivial knot: the \textbf{Trefoil Knot} ($3_1$).

\subsection{Deriving Alpha: The Geometric Impedance}
The Fine Structure Constant ($\alpha \approx 1/137$) is one of the greatest mysteries of physics. In AVE, it is the \textbf{Geometric Impedance Ratio} of the Trefoil. We propose that $\alpha$ represents the coupling efficiency between the linear lattice and the knotted soliton: $\alpha \equiv Z_{vac} / Z_{knot} \approx 1/137.036$.