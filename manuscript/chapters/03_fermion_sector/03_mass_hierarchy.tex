...
By the \textbf{Base-State Degeneracy Postulate}, the rest mass of a single isolated ground-state defect ($N=3$, the Electron) is exactly half the inductive strain required to produce a vacuum pair. The strictly defined AVE Inductive Scaling Equation is:
\begin{equation}
