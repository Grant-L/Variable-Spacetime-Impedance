...
Just as a metal rod expands and softens when heated, the vacuum lattice expands locally under the extreme energy density of the Tau knot ($N=7$). This expansion increases the local lattice pitch ($l_0$), effectively lowering the Inductive Inertia ($\mu_{eff}$) and reducing the measured mass.
