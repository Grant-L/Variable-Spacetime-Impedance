...
\begin{figure}[h]
    ...
    \caption{\textbf{The $6^3_2$ Borromean Proton.} Three continuous electromagnetic flux tubes cross orthogonally in the geometric center. A dense \textit{Tensor Halo} forms where the opposing spatial impedance gradients cancel, structurally generating the macroscopic strong force and the internal tensor core mass of the baryon without collapsing into a point-singularity.}
