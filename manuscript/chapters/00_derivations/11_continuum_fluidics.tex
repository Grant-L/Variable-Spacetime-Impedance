...
\begin{equation}
    a_{genesis} = \frac{c \cdot H_\infty}{2\pi}
\end{equation}
Using the asymptotic geometric bound of $H_\infty \approx 69.32$ km/s/Mpc from our gravity derivations (Chapter 4), this yields:
\begin{equation}
