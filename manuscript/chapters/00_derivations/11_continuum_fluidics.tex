...
\begin{figure}[h]
    ...
    \caption{\textbf{The Bingham-Plastic Superfluid Collapse.} At low metric shear, the Cosserat vacuum acts as a massive rigid solid, naturally dragging the galactic rotation curve (phenomenological Dark Matter). However, precise $43.65$ kV local gravitational stress physically yields the topology into an unstructured fluidic state. This localized avalanche entirely annihilates the local kinematic viscosity ($\eta_{eff} \to 0$), creating frictionless, conservative orbital envelopes for standard planetary motion.}
