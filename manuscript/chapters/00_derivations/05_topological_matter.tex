...
By normalizing the geometric dimensions to the unit cell ($\ell_{node} \equiv 1$), these values reduce to pure dimensionless topological shape factors (analogous to \textbf{Betti numbers} in algebraic topology), resolving all dimensional tautologies. 
