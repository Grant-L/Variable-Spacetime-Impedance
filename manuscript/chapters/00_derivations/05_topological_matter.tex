...
Therefore, the thermodynamic coupling weights for each dimension are mathematically forced to unity ($c_1 = c_2 = c_3 \equiv 1$). The total dimensionless Topological Impedance ($\alpha_{ideal}^{-1}$) of the knot evaluates as the exact, unweighted linear sum of these equipartitioned action capacities:
\begin{equation}
