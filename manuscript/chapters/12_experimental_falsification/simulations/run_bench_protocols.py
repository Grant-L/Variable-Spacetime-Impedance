...
4. Marx Generator: Plots the 60kV Bingham Avalanche Zener knee.
"""
import numpy as np
...
def simulate_ee_bench_protocols():
    ...
    avalanche_idx = V_sweep_kV > 60.0
    I_AVE[avalanche_idx] += (V_sweep_kV[avalanche_idx] - 60.0)**2 * 0.03
    ...
    ax4.axvline(60.0, color='white', lw=1.5, linestyle=':', label='Bingham Yield Point (60 kV)')
