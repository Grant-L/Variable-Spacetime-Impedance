...
When light passes through a moving fluid, its phase velocity is dragged. This is not a quantum postulate; it is governed precisely by the classical 19th-century \textbf{Fresnel-Fizeau Drag Effect}. The measurable interferometric phase shift ($\Delta \phi$) induced in a Fabry-Perot cavity of length $L$ and Finesse $\mathcal{F}$ by this moving fluid is strictly defined by classical optical interferometry:
\begin{equation}
...
Using an optical cavity length of $L = 0.2$ m, a standard $1064$ nm laser, a Finesse of $10,000$, and a Tungsten rotor ($\rho \approx 19,300$ kg/m$^3$) spinning at $v_{tan} \approx 1000$ m/s, the exact predicted parameter-free phase shift is $\approx 7.4$ nano-radians. This places the signal comfortably above the sensitivity limits of advanced squeezed-light interferometers.
