...
VSI resolves this by identifying the \textbf{Inductive Saturation} of the vacuum substrate.
...
\begin{figure}[ht]
    ...
    \caption{\textbf{Galactic Rotation Simulation:} The dashed black line shows the Newtonian prediction, which fails at large radii. The solid blue line shows the VSI prediction using \textbf{Inductive Saturation} with $a_0 \approx 7400$. This successfully matches the observational data at $\approx 120$ km/s without requiring a Dark Matter halo.}
