...
We propose that the vacuum manifold $M_A$ is **Generative**. The Lattice Tension ($P_{vac}$) identified in Chapter 2 drives a continuous phase transition: the crystallization of new lattice nodes from the quantum substrate.
...
\begin{equation}
    \frac{dN}{dt} = R_g N(t)
\end{equation}
Where $R_g$ is the **Node Genesis Rate** (Hz). Solving for $N(t)$:
\begin{equation}
    N(t) = N_0 e^{R_g t}
\end{equation}
