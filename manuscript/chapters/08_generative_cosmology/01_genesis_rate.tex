...
The physical distance $D$ is the node count $N$ times the Lattice Pitch $l_{node}$. The recession velocity $v$ is the rate of growth:
\begin{equation}
    v = \frac{dD}{dt} = l_{node} \frac{dN}{dt} = l_{node} (R_g N) = R_g D
\end{equation}
