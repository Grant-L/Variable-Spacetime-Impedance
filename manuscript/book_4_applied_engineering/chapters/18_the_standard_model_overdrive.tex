...
\begin{figure}[h!]
    \centering
    \includegraphics[width=0.7\textwidth]{../../assets/sim_outputs/uranium_235_assembly_dynamic.png}
...
\begin{figure}[h!]
    \centering
    \includegraphics[width=0.7\textwidth]{../../assets/sim_outputs/macro_molecular_folding_dynamic.png}
