...
\begin{figure}[ht]
    \centering
    \includegraphics[width=0.85\textwidth]{../../src/ave/mechanics/assets/sim_outputs/transmon_decoherence_plot.png}
...
\begin{figure}[ht]
    \centering
    \includegraphics[width=0.85\textwidth]{../../src/ave/mechanics/assets/sim_outputs/topological_qubit_plot.png}
