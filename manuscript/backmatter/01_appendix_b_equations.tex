...
\section{B.5 The Weak Sector (Impedance Bridge)}
The Weak Bosons are identified as impedance resonances of the Proton coupled to the Vacuum.

\textbf{The Base Impedance Scale ($S$)}
\begin{equation}
    S = m_p \cdot \alpha^{-1}_{AVE} \approx 128.58 \text{ GeV}
\end{equation}

\textbf{The W Boson Mass ($5/8$ Harmonic)}
\begin{equation}
    m_W = S \cdot \frac{5}{8} \approx 80.36 \text{ GeV} \quad (\text{Error } 0.02\%)
\end{equation}

\textbf{The Z Boson Mass (Geometric Mixing)}
\begin{equation}
    m_Z = m_W \cdot \frac{3}{\sqrt{7}} \approx 91.12 \text{ GeV} \quad (\text{Error } 0.07\%)
\end{equation}

\section{B.6 Cosmological Dynamics (The Dark Sector)}
