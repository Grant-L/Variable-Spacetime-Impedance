...
\subsection{Planetary Magnetospheres as Impedance Cavities}
...
planet rotates (asymmetry ratio 1.40$\times$).  No other planet
in the solar system exhibits this behaviour --- all others have
$< 12^\circ$ tilt except Neptune ($47^\circ$, 0.55~$R_N$ offset).
