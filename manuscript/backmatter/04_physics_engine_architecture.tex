...
|-- condensed_matter/            condensed_matter.py (T_melt, c_sound,
|                                  E_gap, E_breakdown — Regime II)
...
|-- core/lbm_3d.py               Lattice Boltzmann
...
|-- simulations/topological_optimizer  N-body impedance minimizer
\end{verbatim}
