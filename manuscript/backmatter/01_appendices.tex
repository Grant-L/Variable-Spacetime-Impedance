...
\begin{itemize}
    ...
    \item \textbf{Proton Rest Mass (Geometric Eigenvalue):} $m_p = \frac{\mathcal{I}_{scalar}}{1 - (\text{Total Geometric Volume} \cdot \kappa_V)} \approx \mathbf{1821.4\ m_e}$
...
\begin{itemize}
    ...
    \item \textbf{Absolute Scale of the Universe ($R_H$):} $\frac{R_H}{\ell_{node}} = \frac{\alpha^2}{28\pi\alpha_G} \implies \mathbf{14.1 \text{ Billion Light-Years}}$
    \item \textbf{Absolute Age of the Universe ($t_H$):} $t_H = \frac{R_H}{c} \implies \mathbf{14.1 \text{ Billion Years}}$
