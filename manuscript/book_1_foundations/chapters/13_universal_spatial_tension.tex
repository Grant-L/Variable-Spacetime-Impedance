...
The Muon and Tau are not new ``flavors'' of particles requiring new quantum numbers; they are excitations of this same unknot geometry into higher Cosserat coupling sectors. When the unknot absorbs one quantum of torsional coupling ($\alpha\sqrt{3/7}$), it yields the exact $105.6 \text{ MeV}$ profile of the Muon. When promoted to the full bending stiffness scale ($p_c/\alpha^2$), it hits the $1776.8 \text{ MeV}$ Tau limit. Three Cosserat sectors---translation, rotation, curvature-twist---yield exactly three generations.
