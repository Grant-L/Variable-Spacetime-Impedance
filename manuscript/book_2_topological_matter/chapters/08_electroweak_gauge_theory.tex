...
The Chiral SRS net (Axiom 2) has an intrinsic handedness. A twist that \emph{matches} the lattice chirality propagates freely (this is why left-handed neutrinos are nearly massless). A twist that \emph{opposes} the chirality fights the LC ground state, incurring a stiffness penalty. The torsional permittivity relative to the shear modulus decomposes as:
\begin{equation}
...
$\alpha^2$ & Chirality mismatch energy & Axiom 2 (Chiral LC) \\
