...
\begin{abstract}
    ...
    From these foundational axioms and boundaries, the framework systematically derives:   
    ...
    \begin{itemize}
        ...
        \item \textbf{Gravity:} The continuum limit of a trace-reversed Cosserat solid reproduces the transverse-traceless kinematics of the Einstein Field Equations, establishing a unified geometric identity between $G$ and the cosmological expansion rate ($H_\infty$).
