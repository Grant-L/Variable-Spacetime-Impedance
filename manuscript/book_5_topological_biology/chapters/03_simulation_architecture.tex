...
\midrule
Loss & $320 \to 2.81$ & Convergent \\
$R_g$    & 4.5~\AA & 8--10~\AA \\
End-to-end & 14.7~\AA & $<30$~\AA~\checkmark \\
$\phi$ chirality & 100\% negative & \checkmark \\
$\alpha$-helix & 9\% & $\sim\!60\%$ \\
$\beta$-sheet  & 15\% & --- \\
\bottomrule
\end{tabular}
\end{center}
...
The engine correctly enforces backbone chirality (100\% negative $\phi$) and produces compact structure ($R_g = 4.5$~\AA), but favours the $\beta$-basin ($\phi \approx -120^\circ$, $\psi \approx 130^\circ$) over the $\alpha$-basin ($\phi \approx -60^\circ$, $\psi \approx -40^\circ$).
