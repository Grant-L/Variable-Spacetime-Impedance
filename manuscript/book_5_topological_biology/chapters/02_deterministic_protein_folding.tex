...
Table~\ref{tab:z_topo_values} lists the canonical complex $Z_{topo}$ values from the physics engine (\texttt{protein\_bond\_constants.py}):
...
\midrule
Glycine (G)       & 0.50 & 0.000   & 0.50 & Hydrophobic   & Coil (minimal stub) \\
Alanine (A)       & 0.53 & 0.000   & 0.53 & Hydrophobic   & Alpha-Helix \\
Glutamate (E)     & 0.52 & $-0.074$ & 0.53 & Neg.\ charge  & Alpha-Helix \\
Arginine (R)      & 0.55 & $+0.079$ & 0.56 & Pos.\ charge  & Alpha-Helix \\
Lysine (K)        & 0.60 & $+0.086$ & 0.61 & Pos.\ charge  & Alpha-Helix \\
Glutamine (Q)     & 0.63 & $+0.045$ & 0.63 & Polar         & Alpha-Helix \\
Aspartate (D)     & 0.66 & $-0.094$ & 0.67 & Neg.\ charge  & Moderate \\
Isoleucine (I)    & 0.73 & 0.000   & 0.73 & Hydrophobic   & Alpha-Helix \\
Methionine (M)    & 0.87 & 0.000   & 0.87 & Hydrophobic   & Alpha-Helix \\
Valine (V)        & 0.93 & 0.000   & 0.93 & Hydrophobic   & Beta-Sheet \\
Leucine (L)       & 1.00 & 0.000   & 1.00 & Hydrophobic   & Alpha-Helix \\
Asparagine (N)    & 1.10 & $+0.079$ & 1.10 & Polar         & Moderate \\
Tyrosine (Y)      & 1.31 & $-0.094$ & 1.31 & Polar         & Moderate \\
Phenylalanine (F) & 1.57 & 0.000   & 1.57 & Hydrophobic   & Moderate \\
Serine (S)        & 1.64 & $+0.117$ & 1.64 & Polar         & Coil \\
Threonine (T)     & 1.73 & $+0.124$ & 1.74 & Polar         & Moderate \\
Cysteine (C)      & 1.74 & $-0.124$ & 1.74 & Polar         & Moderate \\
Histidine (H)     & 2.50 & $+0.179$ & 2.51 & Polar (half)  & Moderate \\
Tryptophan (W)    & 3.40 & 0.000   & 3.40 & Hydrophobic   & Beta-Sheet \\
Proline (P)       & 5.02 & 0.000   & 5.02 & Hydrophobic   & Rigid Kink \\
\bottomrule
\end{tabular}
\caption{Complex topological impedance $Z_{topo} = R + jX$ for all 20 standard amino acids. $R$ encodes the sidechain's hydrophobic shunt coupling; $X$ encodes charge reactance scaled by $1/Q$ ($Q \approx 7$, backbone amide-V resonator).  The secondary structure classification is not a simple $|Z|$ threshold---it emerges from the multi-frequency $S_{11}$ response of the full ABCD cascade (Chapter~\ref{ch:protein_sim_architecture}).  No statistical propensity fitting is used.}
