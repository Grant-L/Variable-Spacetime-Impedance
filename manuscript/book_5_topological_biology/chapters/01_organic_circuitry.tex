...
To test the prediction, we overlay the computed transfer function against known experimental FTIR absorption peaks from the NIST Chemistry WebBook and Shimanouchi (1972) reference tables. The predicted curve has a \emph{fixed} frequency scale---no parameters can be tuned to improve agreement.
...
\hline
C--O  & 1.44  & 1.43  & $<$1\%  & 467   & 489   & 5\%  \\
S--H  & 1.12  & 1.34  & 16\%  & 371   & 390   & 5\%  \\
S--S  & 3.25  & 2.05  & 58\%  & 230   & 236   & 3\%  \\
C--H  & 0.84  & 1.09  & 23\%  & 487   & 494   & 1\%  \\
N--H  & 0.86  & 1.01  & 15\%  & 610   & 641   & 5\%  \\
C--C  & 1.44  & 1.54  & 7\%   & 368   & 354   & 4\%  \\
C--N  & 1.44  & 1.47  & 2\%   & 416   & 461   & 10\% \\
C--S  & 2.05  & 1.82  & 13\%  & 261   & 253   & 3\%  \\
O--H  & 0.84  & 0.96  & 12\%  & 791   & 745   & 6\%  \\
C=C   & 1.13  & 1.34  & 16\%  & 967   & 965   & $<$1\%  \\
C=O   & 1.15  & 1.23  & 7\%   & 1176  & 1170  & $<$1\% \\
\hline
\end{tabular}
\caption{Bond parameters derived from first principles versus crystallographic and IR data. With the geometric $4/9$ $\pi$-coupling (Eq.~\ref{eq:pi_coupling}) and $1/9$ lone-pair spatial Q-factor (Eq.~\ref{eq:lp_qfactor}), all 11 essential organic force constants are predicted to within $\leq 10\%$ using zero free parameters.}
