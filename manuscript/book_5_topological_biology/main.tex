...
% --- Graphics & Floats ---
\usepackage{graphicx}
\graphicspath{{../figures/}{../../assets/}{../../assets/figures/}{../../assets/sim_outputs/}{../../assets/derivations/}{../../assets/archive/}{../../notebooks/periodic/helium/}{../../notebooks/cosmology/}{chapters/}{chapters/12_vacuum_circuit_analysis/simulations/outputs/}}
\usepackage{float}
\usepackage{booktabs} 
\usepackage{tabularx}
\usepackage{caption}
