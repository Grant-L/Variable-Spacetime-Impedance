...
$\kappa_\text{HB}$    & $1/(2Q) = 1/14$           & Half-bandwidth coupling & Resonator Q factor \\
...
PYTHONPATH=src python scripts/book_6_topological_biology/s11_fold_engine_v3_jax.py

# Generate SPICE transmission line strain plot
PYTHONPATH=src python scripts/book_6_topological_biology/ \
