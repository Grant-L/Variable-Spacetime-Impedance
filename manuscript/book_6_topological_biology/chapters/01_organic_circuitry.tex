...
python scripts/book_6_topological_biology/generate_amino_spice.py

# Step 2: Solve all 20 netlists and generate the batch plot
python scripts/book_6_topological_biology/batch_amino_spice_solver.py

# Step 3 (optional): Verify Glycine/Alanine against NIST FTIR
python scripts/book_6_topological_biology/simulate_ftir_comparison.py
\end{verbatim}
