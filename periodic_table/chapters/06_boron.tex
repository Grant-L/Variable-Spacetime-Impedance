...
\section{Analytical Derivation of the Halo Distance ($R_{halo}$)}
...
\begin{figure}[h]
    \centering
    \includegraphics[width=1.0\textwidth]{figures/boron_11_bound.png}
    \caption{\textbf{Boron-11 3D Mesh Topology.} A tightly bound Alpha Core sits suspended within a massively dispersed 7-nucleon halo, pushed to the absolute edge of the topological horizon.}
    \label{fig:boron_11_bound}
\end{figure}

\section{Continuous Vacuum Density Flux ($\kappa_V$)}
