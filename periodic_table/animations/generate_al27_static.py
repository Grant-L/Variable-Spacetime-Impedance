...
Z, A = 13, 27
bound, grid_res = 180.0, 100
name = "aluminum_27"
title = "Aluminum-27 ($^{27}Al$): $6\\alpha$ Octahedron + Tritium Polar Halo"
...
# Render the X-Z plane to capture the North polar Tritium asymmetry
