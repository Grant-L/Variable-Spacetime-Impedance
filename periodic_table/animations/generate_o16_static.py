...
plt.savefig(os.path.join(outdir, "oxygen_16_dynamic_flux.png"), facecolor=fig.get_facecolor(), dpi=300)
print("[*] Generated oxygen_16_dynamic_flux.png")
