...
\begin{enumerate}
    ...
    \item \textbf{The Quantum Potential:} For a fluid density $\rho(x) = e^{-x^2/\sigma^2}$, calculate the Quantum Potential $Q(x)$. Show that this creates a repulsive force away from the center of the packet.
    \item \textbf{Dispersion Limit:} Determine the velocity of a particle with energy $E = 10^{19}$ GeV (Planck scale) using the Lindblom Dispersion Relation. How much does it deviate from $c$?
\end{enumerate}