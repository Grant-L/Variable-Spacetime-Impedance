...
\begin{itemize}
    ...
    \item \textbf{Particle Mode (With Observer):} A detector acts as a \textbf{Resistive Load} on the vacuum. Extract energy from the pilot wave (damping). Without the interfering wave to guide it, the electron follows a straight Newtonian path (See Figure \ref{fig:observer_comparison}, Right).
\end{itemize}
...
\begin{figure}[H]
    ...
    \begin{minipage}{0.48\textwidth}
        \centering
        \includegraphics[width=\linewidth]{simulation_elelectron_choice_observer_off.png}
