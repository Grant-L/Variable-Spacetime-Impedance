...
\include{chapter1_hardware}     % The Lattice & Constants
\include{chapter2_gravity}      % Mass & Refraction
\include{chapter3_quantum}      % Pilot Waves & Walkers
\include{chapter4_topology}     % Charge, Protons & Matter
\include{chapter5_cosmology}    % Big Bang & Entanglement
\include{chapter6_observation}  % Vortex Lattice Dark Matter

% --- BACK MATTER ---
\appendix
\include{appendix_defense}      % Theoretical Rebuttals (Aberration, Emergent Gravity)
