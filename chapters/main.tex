...
\usepackage{xcolor}
\usepackage{titlesec}
\usepackage{booktabs} % For nicer tables in Translation Matrix
...
\include{chapter1_hardware}     % The Lattice, Constants & Maxwell Limit
\include{chapter2_gravity}      % Mass, Lensing & Schwarzschild Metric
\include{chapter3_quantum}      % Pilot Waves, Schrödinger Eq & Isotropy
\include{chapter4_topology}     % Charge, Protons & Matter
\include{chapter5_cosmology}    % Big Bang, Entanglement & Kibble-Zurek
\include{chapter6_observation}  % Vortex Halos & Hubble Tension

% --- BACK MATTER ---
\appendix
\include{appendix_defense}      % Theoretical Rebuttals
\include{appendix_code}         % Python Simulation Suite
