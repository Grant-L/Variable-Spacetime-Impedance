...
\include{chapter1}     % The Lattice, Constants & Maxwell Limit
\include{chapter2}      % Mass, Lensing & Schwarzschild Metric
\include{chapter3}      % Pilot Waves, Schrödinger Eq & Isotropy
\include{chapter4}     % Charge, Protons & Matter
\include{chapter5}    % Big Bang, Entanglement & Kibble-Zurek
\include{chapter6}  % Vortex Halos & Hubble Tension
...
\include{bibliography}          % <--- ADD THIS LINE
