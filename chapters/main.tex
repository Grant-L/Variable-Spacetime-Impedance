...
\include{chapter1}     % The Lattice & Constants
\include{chapter2}      % Mass & Refraction
\include{chapter3}      % Pilot Waves & Walkers
\include{chapter4}     % Charge, Protons & Matter
\include{chapter5}    % Big Bang & Entanglement
\include{chapter6}    % Vacuum as a Polarized TVS Filterl
\include{chapter7}  % Vortex Lattice Dark Matter

% --- BACK MATTER ---
\appendix
\include{chapters/appendicies}            % Theory Defenses A, B, C
\include{chapters/appendix_code}         % Simulation Code D

\include{chapters/bibliography}          % References
