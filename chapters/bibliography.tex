\begin{thebibliography}{9}
    ...
    (The foundational text on superfluid vacuum analogs).
    ...
    (The experimental basis for the Walker Model).
    ...
    (The basis for the crystallization hypothesis).
    ...
    (The original proposal of the acoustic metric).
