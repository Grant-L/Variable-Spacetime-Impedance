...
A warp drive functions by creating a localized pressure gradient: High Pressure (Compression) in the front, Low Pressure (Rarefaction) in the rear. This propels the bubble through the network.
\begin{equation}
...
\begin{figure}[ht]
    ...
    \caption{\textbf{Warp Drive Hydrodynamics.} Simulation of a superluminal pressure source moving through the vacuum network. \textbf{A:} The Bow Shock (Mach Cone) where network piles up. \textbf{B:} The Laminar Bubble where the ship resides. \textbf{C:} The Turbulent Wake trailing the vessel.}
    \label{fig:warp_wake}
\end{figure}