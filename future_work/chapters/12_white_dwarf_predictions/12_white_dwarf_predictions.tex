...
\input{../manuscript/common_equations/eq_axiom_3.tex}
...
Scripts:
\begin{itemize}
    \item \texttt{scripts/vol\_4\_engineering/white\_dwarf\_saturation\_redshift.py}
    \item \texttt{scripts/vol\_4\_engineering/wd\_shear\_eigenfrequency.py}
\end{itemize}
