...
% --- Graphics & Floats ---
\usepackage{graphicx}
\graphicspath{{../assets/}{../assets/figures/}{../assets/sim_outputs/}{../assets/derivations/}{../assets/archive/}{../notebooks/periodic/helium/}{../notebooks/cosmology/}{chapters/01_experiments/simulations/outputs/}}
\usepackage{float}
\usepackage{booktabs} 
\usepackage{tabularx}
\usepackage{caption}
...
\fancyhead[RE]{\itshape Experimental Protocols}
...
\input{chapters/01_sagnac_rlve/_manifest.tex}
\input{chapters/02_autoresonant_birefringence/_manifest.tex}
\input{chapters/03_lc_lattice_analog/_manifest.tex}
\input{chapters/04_superfluid_helium/_manifest.tex}
