...
\newtcolorbox[auto counter, number within=chapter]{knotbox}[1][]{
    colback=purple!5!white, colframe=purple!50!black, fonttitle=\bfseries,
    title=Knot Topology \thetcbcounter: #1, enhanced, breakable
}
\newenvironment{knot}[1][]{\begin{knotbox}[#1]}{\end{knotbox}}
